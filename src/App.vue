<template>
  <router-view />
  <a
    href="https://api.whatsapp.com/send/?phone=%2B573223003840&text=Hola%2C%20quiero%20información%20sobre%20sus%20servicios"
    target="_blank"
...
.wa-fab {
  ...
  display: grid;
  place-items: center;
  box-shadow: 0 6px 24px rgba(37,211,102,.45), 0 2px 8px rgba(0,0,0,.25);
